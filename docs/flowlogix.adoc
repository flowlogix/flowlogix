...
Admittedly, most functionality is already covered by Jakarta EE, PrimeFaces, OmniFaces, Apache Shiro and other very popular software. However, there are still a few missing pieces that remain.
...
=== Where does FlowLogix fit into your application arhitecture?
[role="arc42help"]
****
.Is it a framework?
