...
image:https://img.shields.io/badge/Reproducible_Builds-ok-success?labelColor=1e5b96[link="https://github.com/jvm-repo-rebuild/reproducible-central/blob/master/content/com/flowlogix/README.md"]
