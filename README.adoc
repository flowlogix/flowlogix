...
== Quick Start (only JDK is required)
...
- 4/24/2026: Version 11.4 was released, removing serialization requirements for Entity / Data objects in JPALazyDataModel, even with distributed sessions
- 3/28/2026: Version 11.2 was released with Cursor Pagination for JPALazyDataModel
...
image:https://static.scarf.sh/a.png?x-pxid=d8c39487-b1ab-48e5-88c6-8e4b3b6b41ae&page=README-ee-components.adoc[,0,0]