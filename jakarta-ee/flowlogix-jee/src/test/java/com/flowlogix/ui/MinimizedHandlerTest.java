...
public class MinimizedHandlerTest {
    @Test
    void js() {
        MinimizedHandler handler = new MinimizedHandler("min", parseExtensions("css, js, ts"));
    ...
    @Test
    void onlyOne() {
        MinimizedHandler handler = new MinimizedHandler("min", parseExtensions(", js"));
        assertEquals("my.min.js", handler.toMinimized("my.js"));
        assertEquals("my.js.xhtml", handler.toMinimized("my.js.xhtml"));
    }
    ...
    @Test
    void none() {
        MinimizedHandler handler = new MinimizedHandler("min", parseExtensions(""));
