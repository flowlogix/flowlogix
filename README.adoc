...
- Jakarta EE Lazy Data Model for PrimeFaces DataTable image:https://img.shields.io/maven-central/v/com.flowlogix/flowlogix-jee?label=Javadoc[link="https://javadoc.flowlogix.com/datamodel-apidocs",window=_blank]
- Apache Shiro Security / Jakarta EE integration - Now part of https://shiro.apache.org/jakarta-ee.html[Apache Shiro^]
- Jakarta EE DAO Helper image:https://img.shields.io/maven-central/v/com.flowlogix/flowlogix-jee?label=Javadoc[link="https://javadoc.flowlogix.com/jee-apidocs",window=_blank]
...
- 6/2/2023: Version 7.0 has been released
