...
[[section-quick-start]]
== Quick Start
link:https://start.flowlogix.com[Generate your project^] and run it in seconds
[source,shell]
.Only JDK is required
----
...
FlowLogix provides a few remaining missing pieces in what is covered by Jakarta EE, PrimeFaces, OmniFaces and other very popular software.
...
* Easier-to-use, Injected JPA Lazy Data Model for PrimeFaces DataTable that supports cursor pagination and clustered sessions, without requiring Entities to be Serializable
...
* Simplify creation and manipulation of ShrinkWrap and Arquillian test archives including assets, allowing for better integration tests
...
----
include::../../jee-examples/pom.xml[tags=dependenciesStart,indent=0]
        <groupId>com.flowlogix</groupId>
        <artifactId>flowlogix-jee</artifactId>
        <version><<LATEST>></version>
include::../../jee-examples/pom.xml[tags=dependenciesEnd,indent=0]
----
[source,xml]
...
=== Flow Logix BOM
Flow Logix includes an easy way to declare all the required dependency versions, via the Maven Bill of Materials. It is automatically included when using https://docs.flowlogix.com/base-pom[FlowLogix Base POM].
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/UserDAO.java[tags=daoParameters,indent=0]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/UserDAO.java[Full Demo on GitHub^]
[source,java]
.Composable query with customized parameters
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/UserDAO.java[tags=daoExtractedParameters,indent=0]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/UserDAO.java[Full Demo on GitHub^]
...
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao[Full Demos on GitHub^]

[source,java]
.Simple DAO Example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/ExampleDAO.java[tags=simpleExampleDAO,indent=0]
----
[source,java]
.Injected DAO example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/InjectedDAO.java[tags=injectedExampleDAO,ident=0]
----
[source,java]
.Non-Default annotation example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/NonDefault.java[tags=nonDefault,indent=0]
----
[source,java]
.Non-Default EntityManager injection example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/InjectedEntityManager.java[tags=injectedEntityManager]
----
[source,java]
.Injected DAO with non-default EntityManager
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/InjectedNonDefaultDAO.java[tags=injectedNonDefaultExampleDAO,ident=0]
----
[source,java]
.More complete DAO example that forwards `EntityManager` methods
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/ExampleDelegateDAO.java[tags=delegateDAO]
----
[source,java]
.Non-default EntityManager Producer example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/EntityManagerProducer.java[tags=nonDefaultEntityProducer,ident=0]
----
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/StatelessEntityManagerProducer.java[tags=statelessEntityProducer,ident=0]
----
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/InheritedDAO.java[tags=inheritedDAO]
----
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/jeedao/UserDAO.java[tags=nativeQuery,indent=0]
----
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/TypeConverterDemo.java[tags=typeConvert,indent=0]
----
[source,java]
.Convert and check if returned value matches the input after the conversion, without throwing any exceptions
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/TypeConverterDemo.java[tags=checkTypeConvert,indent=0]
----
...
.Servlet example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/ui/JakartifyDemo.java[tags=jakartifyServlet,indent=0]
----
[source,java]
.Jakarta Faces example
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/ui/JakartifyDemo.java[tags=jakartifyError,indent=0]
----
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/SerializeDemo.java[tags=serialize,indent=0]
----
...
[source,java]
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ReadStringDemo.java[tags=readStringFromStream,indent=0]
----
...
----
@Deployment
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java[tags=deployMaven,indent=0]
----
.Creating ShrinkWrap (Arquillian) tests easily from maven POM file with prod suffix
[source,java]
----
@Deployment
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java[tags=deployMavenSuffix,indent=0]
----
...
----
@Deployment
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java[tags=productionMode,indent=0]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java#L54[Full Demo on GitHub^]
...
----
include::../../flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java[tags=persistence,indent=0]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-jee/src/demo/java/com/flowlogix/demo/util/ShrinkWrapDemo.java#L69[Full Demo on GitHub^]
...
include::../../jee-examples/src/main/java/com/flowlogix/examples/data/UserViewer.java[tags="simpleLazyDataModelUsage"]
}
----
https://github.com/flowlogix/flowlogix/tree/main/jee-examples/src/main/java/com/flowlogix/examples/data/UserViewer.java[Full Demo on GitHub^]
...
[[section-jpa-lazymodel-cursor-pagination]]
==== Cursor Pagination (FlowLogix DataModel 11.2 or higher)
When using `JPALazyDataModel` with large datasets, cursor pagination can be used instead of offset pagination for better performance. Cursor pagination is also available with infinite scroll. To use cursor pagination, add `cursor(CursorPagination.create(List<Field>, ...))` to the Model's initializer. Order of fields matter, as the first field is considered the default cursor and the unique tiebreaker. When no sort criteria is specified by the user, the first field specified is used to sort the data, which is required for cursor pagination to work. When the user sorts by a different field, that field may be used as the cursor instead, but only if specified by supported fields. If a user sorts by a field that is unsupported by cursor pagination, the model falls back to offset pagination. Cursor pagination works best when the fields used for sorting are indexed in the database.

===== How Cursor Pagination works
Cursor pagination works by keeping track of the last seen record's position (the cursor) and using it as additional criteria to fetch the next set of records. This approach avoids performance issues associated with offset pagination, which can become slower as the offset increases. With cursor pagination, the database can efficiently retrieve the next set of records based on the last seen record, resulting in faster response times, especially for large datasets. Each time a new page of data is received, the last cursor value is cached. Take care of keeping the cursor values small, such as an integer, UUID or a short string to avoid using too much memory for the cursor cache. Cache eviction may be configured via `evictCursor*` and `*CursorWindowSize` parameters.

The cursor position is an ordering tuple: the value of the requested sort column on the last row of the page, plus the value of the first configured field on the same row. The first configured field must be stable and unique (e.g. `id` or `createdDate`), because it is appended as an ascending tiebreaker to every cursor query's `ORDER BY`, making the ordering total. The cursor predicate is then lexicographic: `sort > value OR (sort = value AND tiebreaker > tiebreakerValue)`, reversed for descending, so rows whose sort value equals the page boundary value are never skipped or repeated, even when the sort column contains duplicates spanning a page boundary.

NOTE: High-priority application sort is not supported with cursor pagination, and is ignored when cursor pagination is enabled. This is because cursor pagination requires the high-priority sort to be the same as the cursor field, and changing it would cause unexpected behavior.

[source,java]
.UserViewer.java - Cursor Pagination example
----
@Named
@ViewScoped
public class UserViewer implements Serializable {
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/CursorDataModel.java[tags=usage]
----
https://github.com/flowlogix/flowlogix/tree/main/jee-examples/src/main/java/com/flowlogix/examples/data/UserViewer.java[Full Demo on GitHub^]

Above, cursor pagination is used, if the data is either unsorted or sorted by `UserEntity.id` field.
...
@ViewScoped
public class UserViewer implements Serializable {
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/DirectCreationDataModel.java[tags=basicUsage]
}
----
https://github.com/flowlogix/flowlogix/tree/main/jee-examples/src/main/java/com/flowlogix/examples/data/UserViewer.java[Full Demo on GitHub^]
...
* joinType: Specifies the `jakarta.persistence.criteria.JoinType` used when resolving dotted (nested) field references in filters and sort criteria. Default is `LEFT`, so entities with null to-one associations are still returned when sorting or filtering on columns of those associations. Set to `INNER` (or use `@LazyModelConfig(innerJoins = true)`) only for applications that deliberately rely on inner join semantics.
...
* cursor: Use cursor pagination instead of offset pagination for better performance with large datasets
...
NOTE: Dotted (nested) field references, such as `address.city`, share a single `LEFT` join per query between filter, sort and count criteria, and filtering over a to-many association uses `DISTINCT` (and `COUNT(DISTINCT ...)` for the count query), so each matching entity is returned exactly once and `count()` always agrees with the paged rows.

Let's use custom criteria to add address to the default sort:
[source,java]
.Add sorting by zip code
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/SortingDataModel.java[tags=sorting]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/SortingDataModel.java[Full Demo on GitHub^]
...
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/FilteringDataModel.java[tags=filtering]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/FilteringDataModel.java[Full Demo on GitHub^]
...
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/OptimizedDataModel.java[tags=optimized]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/OptimizedDataModel.java[Full Demo on GitHub^]

Results Enricher can be used to post-process the results of the query:
[source,java]
.Add a new row to the results
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/EnrichedDataModel.java[tags=enriched]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/EnrichedDataModel.java[Full Demo on GitHub^]
...
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/QualifiedDataModel.java[tags=qualifier]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/QualifiedDataModel.java[Full Demo on GitHub^]
...
----
include::../../flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/ConverterDataModel.java[tags=converter]
----
https://github.com/flowlogix/flowlogix/tree/main/flowlogix-datamodel/src/demo/java/com/flowlogix/demo/jeedao/primefaces/ConverterDataModel.java[Full Demo on GitHub^]
