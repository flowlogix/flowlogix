...
import com.flowlogix.demo.jeedao.NotDefault;
...
@Named
@ViewScoped
public class QualifiedDataModel3 implements Serializable {
    @Inject
    @Getter
    @EntityManagerSelector(NonDefault.class)
    @LazyModelConfig(entityManagerSelector = NotDefault.class)
